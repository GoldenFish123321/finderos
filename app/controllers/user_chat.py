...
# ── 系统 Prompt 模板（从 docs/prompts/ 加载）──

def _load_prompt(filename: str) -> str:
    """从 docs/prompts/ 目录加载 prompt 模板文件。"""
    path = os.path.join(os.path.dirname(__file__), '..', '..', 'docs', 'prompts', filename)
    try:
...
_SYSTEM_IDENTITY = _load_prompt('system_identity.txt')
_CHART_INSTRUCTION = _load_prompt('chart_instruction.txt')
_TOOL_USAGE_INSTRUCTION = _load_prompt('tool_usage_instruction.txt')
_MEDIA_INSTRUCTION = _load_prompt('media_instruction.txt')
