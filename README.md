...
✋ 手势交互 — 摄像头实时手势识别        — 剪刀手/握拳/手掌 → @天气/@随机音乐/@新闻聚合，识别成功自动关闭
...
- **手势识别说明**：聊天页顶部“手势”旁提供“说明”入口，摄像头预览与操作说明分区展示，避免视频或骨架画布遮挡 `✌️ 剪刀手 → @天气`、`✊ 握拳 → @随机音乐`、`✋ 手掌 → @新闻聚合` 的映射和冷却规则。识别成功后自动关闭摄像头并返回对话界面，流式输出中触发的识别会被忽略且不关闭摄像头。
