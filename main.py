...
from app.controllers.auth import LoginHandler, LogoutHandler, RegisterHandler, UserAccountHandler, FaceRegisterHandler, FaceLoginHandler
...
from app.controllers.user_chat import (
    ...
    UserChatTTSHandler, UserLocationReverseHandler,
)
...
def make_app() -> tornado.web.Application:
    ...
    return tornado.web.Application(
        [
            ...
            # 浏览器定位反查城市（手势天气）
            (r"/api/location/reverse", UserLocationReverseHandler),
        ],
